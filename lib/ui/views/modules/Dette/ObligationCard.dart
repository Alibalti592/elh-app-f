...
//   bool directShare = false;
//   ObligationCard({required this.obligation, required this.directShare});
//   @override
//   ObligationCardState createState() => ObligationCardState(obligation: obligation, directShare: directShare);
// }
...
//         viewModelBuilder: () => ObligationCardController(this.directShare, obligation: obligation),
...
//                           children: [
//                             Text("Bismillahi R-Rahmani R-Rahim", style: TextStyle(color: white, fontFamily: 'Karla', fontWeight: FontWeight.w600, fontSize: 16),),
//                             UIHelper.verticalSpace(0),
//                             Text(obligation.type == "amana" ? "Détails de la amana" :  "Détails de la dette", style: TextStyle(color: fontGreyDark, fontFamily: 'Karla', fontWeight: FontWeight.w600, fontSize: 14),),
//                             UIHelper.verticalSpace(7),
//                             _itemIUsers(obligation),
//                             UIHelper.verticalSpace(7),
//                             _item(MdiIcons.calendarOutline, obligation.dateDisplay, title: 'Date'),
//                             //PRET / EMPRUNT
//                             obligation.type != 'amana' ? Column(
//                               children: [
//                                 UIHelper.verticalSpace(obligation.amount != 0 ? 7 : 0),
//                                 obligation.amount != 0 ? _item(MdiIcons.cashCheck, "${obligation.amount} €", title: 'Montant') : Container(),
//                                 UIHelper.verticalSpace(7),
//                                 _item(MdiIcons.noteOutline, obligation.delay, title: controller.raisonText(obligation)),
//                                 UIHelper.verticalSpace(7),
//                                 obligation.dateStartDisplay != null ?
//                                 _item(Icons.calendar_month_outlined, obligation.dateStartDisplay,
//                                     title: 'Remboursement au plus tard ') : Container(),
//                               ],
//                             ) : Container(),
//                             //AMANA
//                             obligation.type == 'amana' ? Column(
//                               children: [
//                                 UIHelper.verticalSpace(7),
//                                 _item(MdiIcons.noteOutline, obligation.raison, title:"Se sont mis d'accord pour"),
//                               ],
//                             ) : Container(),
//                             UIHelper.verticalSpace(4),
//                             Center(
//                               child: Image(image: AssetImage("assets/images/logo-no-bg.png"), height: 60),
//                             ),
...
//                       builder: (BuildContext context, bool isSharing, Widget? child) {
//                         return isSharing ? Container(height: 10) :  Positioned(
//                             top: 10,
//                             right: 5,
...
//                     ValueListenableBuilder<bool>(
//                       builder: (BuildContext context, bool isSharing, Widget? child) {
//                         return (isSharing || this.directShare) ? Container(height: 50) :  Positioned(
//                             bottom: 10,
//                             right: 10,
...
//                                   },
//                                   child: Icon(MdiIcons.shareVariantOutline, color: Colors.white),
//                                   style: ElevatedButton.styleFrom(
//                                       shape: CircleBorder(),
...
//                       Text("Préteur : ", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12, color: fontGrey)) :Container(),
//                     SizedBox(width: 1), // Adds spacing between elements
//                     Column(
//                       crossAxisAlignment: CrossAxisAlignment.start,
//                       children: [
//                         SizedBox(
...
//                   ],
//                 ),
//                 //Text('et', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 8, color: fontGrey)),
...
//                       Text(
//                         "Emprunteur : ",
//                         style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12, color: fontGrey),
//                     ),
//                     SizedBox(width: 1), // Adds spacing between elements
//                     Column(
//                       crossAxisAlignment: CrossAxisAlignment.start,
...
//                   width: 195,
//                   child:
//                     Text(title, style: TextStyle(color: fontGrey, fontSize: 10)),
//                 ) : Container(),
//                 Container(
//                   width: 190,
//                     child: Text(text, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: Colors.black))
//                 ),
//                 extraTextWidget != null ? extraTextWidget : Container()
//               ],
//             ),
//           ],
//         ),
