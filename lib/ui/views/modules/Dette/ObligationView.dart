...
class _ObligationViewState extends State<ObligationView> {
                ...
                try {
                  final newTranche = await _trancheService
                      .createTranche(
                        ...
                        amount,
                        dateText,
                        fileUrl: _controller.fileUrl.value,
                      )
  ...
  Future<void> _addTranche() async {
    ...
    if (obligationId == null || emprunteurId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Obligation ou emprunteur invalide")),
      );
      return;
    }
                  ...
                  return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: ElevatedButton(
                          ...
                          onPressed: () async {
                            print((tranche.fileUrl ?? "no file url"));
