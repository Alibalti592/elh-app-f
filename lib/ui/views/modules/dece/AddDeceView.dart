...
class AddDeceViewState extends State<AddDeceView> {
    ...
    return ViewModelBuilder<AddDeceController>.reactive(
      ...
      builder: (context, controller, child) => Scaffold(
            ...
            appBar: AppBar(
                ...
                title: Text("Contacter des pompes funèbres", style: headerTextWhite),
                actions: [
                      ...
                      return isSaving ? BBloader() :  Center(
                        child: GestureDetector(
                          ...
                          child: Container(
                              ...
                              child: Text('Enregistrer', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700))),
                        ),
                      );
                    },
            ...
            body: SafeArea(
              child: Container(
                ...
                child: ListView(
                  children: [
                    controller.isLoading ? BBloader() : Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('Date du décès', style: labelSmallStyle),
                          ),
                          Container(
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 10),
                            child: Text('Lieu du décès', style: labelSmallStyle),
                          ),
                          DropdownButtonFormField<String>(
                              value: controller.newDece.lieu,
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              onTap: () {
                                controller.openSearchLocation(context, 'adresse1');
                              },
                              readOnly: true,
                              maxLines: 1,
                              decoration: InputDecoration(
                                  ...
                                  filled: true,
                                  fillColor: white,
                                  labelText: controller.newDece.lieu == 'maison' ? "Adresse du défunt" : "Adresse de l'hôpital"),
                            ),
                          ),
                          //notif pompe funebre
                          UIHelper.verticalSpace(10),
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                filled: true,
                                fillColor: white,
                                labelText: "Téléphone pour être contacté"),
                          ),
                          UIHelper.verticalSpace(10),
                        ],
                      ),
  ...
  List<DropdownMenuItem<String>> _selectOptions(AddDeceController controller, String type ) {
