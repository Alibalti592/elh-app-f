  ...
  static Route<dynamic> generateRoute(settings) {
    switch (settings.name) {
      ...
      case 'profileInfos':
        ...
        return MaterialPageRoute(builder: (_) => ProfileView(userInfos: arguments['userInfos']));
      case 'navigationParameters':
        final  arguments = settings.arguments;
        return SlideRightRoute(page: NavigationParametersView(userInfos: arguments['userInfos']));

      case 'chatThread':
        final  arguments = settings.arguments;
        return MaterialPageRoute(builder: (_) => ChatView(thread: arguments['thread']));

      case 'deceDetails':
        final  arguments = settings.arguments;
        return MaterialPageRoute(builder: (_) => DeceDetailsView(arguments['dece']));

      case 'carteListView':
        final  arguments = settings.arguments;
        return MaterialPageRoute(builder: (_) => CarteListView(openCarte: arguments['openCarte']));
